...
const Header = () => {
  ...
  return (
    <nav
      className={`fixed w-full z-50 transition-all duration-500 ${scrolled ? "bg-darkblue/95 backdrop-blur-md py-3 shadow-2xl" : "bg-transparent py-6"}`}
    >
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden absolute top-full left-0 w-full bg-darkblue border-t border-ivory/10 transition-all duration-300 ${isOpen ? "max-h-screen opacity-100 py-8" : "max-h-0 opacity-0 overflow-hidden"}`}
      >
